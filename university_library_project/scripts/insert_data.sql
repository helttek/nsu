...
(1, 'Абонемент', 50, 'Active', 'Главный абонемент'),
(2, 'Читальный зал', 100, 'Active', 'Читальный зал №1 (Гуманитарные науки)'),
(3, 'Абонемент', 30, 'Maintenance', 'Абонемент для преподавателей'),
(4, 'Читальный зал', 75, 'Active', 'Читальный зал №2 (Технические науки)'),
(5, 'Межбиблиотечный абонемент', 10, 'Active', 'Отдел МБА'),
(6, 'Абонемент', 20, 'Inactive', 'Абонемент редких книг'),
(7, 'Читальный зал', 60, 'Active', 'Читальный зал периодики'),
(8, 'Справочный отдел', 5, 'Active', 'Справочно-библиографический отдел');
